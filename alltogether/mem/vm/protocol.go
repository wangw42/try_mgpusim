...
func (b TranslationReqBuilder) WithRemote(remote int) TranslationReqBuilder {
	b.remote = remote
	return b
}

func (b TranslationReqBuilder) WithMigrate(migrate int) TranslationReqBuilder {
	b.migrate = migrate
	return b
}


func (b TranslationReqBuilder) WithGmmuhit(gmmuhit int) TranslationReqBuilder {
	b.gmmuhit= gmmuhit
	return b
}
